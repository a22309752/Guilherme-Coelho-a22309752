...
class Turma (models.Model):
    ...
    professor = models.OneToOneField(Professor, on_delete=models.CASCADE, related_name="turma",null=True, blank=True) #professor 1:1 turma
...
class Aluno (models.Model):
    ...
    turma = models.ForeignKey(Turma, on_delete = models.CASCADE, related_name= "alunos",null=True, blank=True) #turma 1:N aluno
